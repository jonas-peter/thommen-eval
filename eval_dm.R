...
data <- read.csv(paste0('data_generated/df_dm.csv', sep=''))
...
################################################################################
# # Displacement at UF With respect to BV/TV:
################################################################################

titel <- 'Displacement at UF vs. BV/TV'

dir.create("plots")
jpeg(paste0('plots/EXP_DM.jpg'), units = "mm", width = 150, height = 130, res = 400)

plot2setts(bvtvgE, yE, bvtvgN, yN,
           'BV/TV []', 'Displacement at UF [mm]',
           'red', 'blue',
           'Element', 'Nevo',
           titel)
dev.off()
...
################################################################################
# # Values for descriptive stat for Displacement at UF:
################################################################################

cat("\nDescriptive Stat Displacement at UF\n\n")
# mean:
meanE <- mean(yE)
