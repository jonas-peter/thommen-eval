...
data <- read.csv(paste0('data_generated/df_uf.csv', sep=''))
...
################################################################################
# # Ultimate Force With respect to BV/TV:
################################################################################

titel <- 'Ultimate Force vs. BV/TV'

dir.create("plots")
jpeg(paste0('plots/EXP_UF.jpg'), units = "mm", width = 150, height = 130, res = 400)

plot2setts(bvtvgE, yE, bvtvgN, yN,
           'BV/TV []', 'Ultimate Force [N]',
           'red', 'blue',
           'Element', 'Nevo',
           titel)
dev.off()
...
################################################################################
# # Values for descriptive stat for Ultimate Force:
################################################################################

cat("\nDescriptive Stat Ultimate Force\n\n")
# mean:
meanE <- mean(yE)
